function myFunction() {
    ...
    var a = function () {
        ...
        $.getJSON("https://api.discogs.com/database/search?q=" + artistInput + "&key=KyadyLRNlEcmPkuGSwup&secret=UOGgnAGWOgGASqQNfZrIaEpgUEZoyKdQ", function (data) {
            ...
            var thumbStf = "<div class='jumbotron stupid'><a target='_blank' href='http://www.discogs.com" + artistLink + "'><img " +
                " src='" + artistThumb + "'></a>";
            //$(thumbStf).appendTo(".profileImage");
            if (artistInput.length != 0) {
                $.getJSON("https://api.discogs.com/artists/" + artistID, function (data) {
