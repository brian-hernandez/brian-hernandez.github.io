...
function setup() {
    ...
    var id = resources["./img/snow.json"].textures;

    // Background
    var bg = new Sprite(id["bg.jpg"]);
    stage.addChild(bg);
    ...
    for (var i = 0; i < numberOfTanks; i++) {
        ...
        var y = randomInt(0, stage.height - etank.height);
        etank.x = x;
        etank.y = y;
        etank.tint = 0xff0000;
