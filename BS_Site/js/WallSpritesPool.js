...
/*
 Functions for Borrowing/Returning to pool
 */
...
/*
 Functions that creates the sprites
 */
...
/*
 Functions that add Sprites to array
 */
...
WallSpritesPool.prototype.addBackEdgeSprites = function (amount, frameId) {
    for (var i = 0; i < amount; i++) {
        var sprite = new PIXI.Sprite(PIXI.Texture.fromFrame(frameId));
        // Flipping the image to correspond to the rest of the image
        sprite.anchor.x = 1;
        sprite.scale.x = -1;
        this.backEdges.push(sprite);
    }
